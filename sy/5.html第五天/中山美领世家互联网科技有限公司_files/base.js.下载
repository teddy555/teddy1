...
tab_change('#b-allbrand .tab li','curr','#b-allbrand .tabcon');//品牌列表页 切换分类下的品牌
 ...
 $("#open").hover(function(){
	  $(this).find('.all_categories').stop(true, true).slideDown(300);
	 },function(){
	 	$(this).find('.all_categories').stop(true, true).slideUp(300);
	 });
 ...
 $("#awei").hover(function(){
	  $("#gwei").stop(true, true).show(300);
	 },function(){
	  $("#gwei").stop(true, true).hide(300);
	 });